...
%o`, message, error2, detail);
  ...
  // app/assets/builds/jquery.raty.js
  (function($) {
    "use strict";
    var methods = {
      ...
      _between: function(value, min2, max2) {
        return Math.min(Math.max(parseFloat(value), min2), max2);
      },
      _binds: function() {
        if (this.cancel) {
      ...
      _bindClick: function() {
        ...
        that.stars.on("click.raty", function(evt) {
          var execute2 = true, score = that.opt.half || that.opt.precision ? that.self.data("score") : this.alt || $(this).data("alt");
          if (that.opt.click) {
            execute2 = that.opt.click.call(that, +score, evt);
          }
          if (execute2 || execute2 === void 0) {
      ...
      _fill: function(score) {
        ...
        for (var i = 1; i <= this.stars.length; i++) {
          ...
          if (this.opt.iconRange && this.opt.iconRange.length > hash3) {
            var irange = this.opt.iconRange[hash3];
      ...
      cancel: function(click) {
        return this.each(function() {
          var self2 = $(this);
          if (self2.data("readonly") !== true) {
            methods[click ? "click" : "score"].call(self2, null);
      ...
      destroy: function() {
        return this.each(function() {
          var self2 = $(this), raw = self2.data("raw");
          if (raw) {
            self2.off(".raty").empty().css({ cursor: raw.style.cursor }).removeData("readonly");
          } else {
            self2.data("raw", self2.clone()[0]);
          }
        });
      },
      getScore: function() {
      ...
      readOnly: function(readonly) {
        return this.each(function() {
          var self2 = $(this);
          if (self2.data("readonly") !== readonly) {
            if (readonly) {
              self2.off(".raty").children("img").off(".raty");
              methods._lock.call(this);
            } else {
              methods._binds.call(this);
              methods._unlock.call(this);
            }
            self2.data("readonly", readonly);
          }
        });
      },
      reload: function() {
      ...
      score: function() {
        var self2 = $(this);
        return arguments.length ? methods.setScore.apply(self2, arguments) : methods.getScore.call(self2);
      },
